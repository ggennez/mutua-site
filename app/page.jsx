...
const css = `
  ...
  .stats-cell { background: ${s.dark}; padding: 60px 52px; }
  .process-row {
    display: grid;
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        width: '52vw',
        height: '52vw',
        background: 'radial-gradient(circle, rgba(16,63,234,0.09) 0%, transparent 68%)',
        pointerEvents: 'none',
      }} />
...
/* ─── MANIFESTO ─────────────────────────────────────────── */
/* deliberate full-theme break: one editorial light pause */
function Manifesto() {
  return (
    <section style={{
      background: '#F2F2F0',
...
function Stats() {
  const items = [
    ...
    { n: '40%', label: 'do CAC desperdiçado por falta de rastreamento adequado' },
  ];
...
function Parceria() {
  const steps = [
    {
      title: 'Diagnóstico',
      desc: 'Mapeamos seu funil atual, dados disponíveis e principais oportunidades em uma reunião de 60 minutos.',
    },
    {
      title: 'Estratégia',
      desc: 'Montamos o plano de Revenue Ops adaptado ao seu momento, recursos e metas de crescimento.',
    },
    {
      title: 'Implementação',
      desc: 'Executamos as mudanças, configuramos o tracking e lançamos os primeiros experimentos de crescimento.',
    },
    {
      title: 'Resultados',
      desc: 'Revisões semanais com métricas reais, ajustes rápidos e relatórios executivos mensais.',
    },
  ];
  ...
  return (
    <section id="contato" style={{
      ...
      <div style={{
        ...
        width: '60vw',
        height: '40vw',
        background: 'radial-gradient(ellipse, rgba(16,63,234,0.12) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
